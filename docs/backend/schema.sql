...
create table if not exists consulting_partner_applications (
  ...
  category_ids text[] not null default '{personalColor}',
  introduction text not null default '',
  consulting_modes text[] not null default '{online}',
  price_30_min integer not null default 0,
  price_60_min integer not null default 0,
  online_price_30_min integer,
  online_price_60_min integer,
  offline_price_30_min integer,
  offline_price_60_min integer,
  offline_address text,
  offline_detail_address text,
  offline_location_note text,
  business_registration_file_name text,
  beauty_license_file_name text,
  additional_certificate_file_names text[] not null default '{}',
  status text not null default 'submitted',
  expert_id text,
